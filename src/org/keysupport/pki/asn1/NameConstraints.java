package org.keysupport.pki.asn1;
 ...
 * the 1.50 version of the Bouncy Castle Java API.
 * 
 * We duplicate the code here to maintain backwards
 * compatibility with the 1.47 API, and to include
 * constructors which will generate the generalNames
 * sequence from the server's properties configuration.
 */
public class NameConstraints extends ASN1Object {
	...
	/**
	 * Create an empty NameConstraints object
	 */
	public NameConstraints() {
		/*
		 * Do nothing, it will be an empty
		 * tagged sequence.
		 */
	}

	public void getPermittedSubtrees(GeneralSubtree[] permitted) {
		this.permitted = permitted;
	}

	public void setExcludedSubtrees(GeneralSubtree[] excluded) {
